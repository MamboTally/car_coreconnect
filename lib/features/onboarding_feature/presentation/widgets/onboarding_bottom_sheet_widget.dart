...
//import 'package:car_coreconnect/features/authentication_feature/presentation/screens/authentication_screen.dart';
import 'package:car_coreconnect/features/onboarding_feature/presentation/bloc/onboarding_cubit.dart';
import 'package:car_coreconnect/login.dart' show Login;
      ...
      child: Row(
        ...
        children: [
          ...
          TextButton(
            ...
            child: Text(
              watch.state.position == 3 ? 'Enter' : 'Next',
            ),
          ),
        ],
      ),
